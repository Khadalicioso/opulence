...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="50" placeholder="Property Name" class="input">
      </div>
      <div class="flex">
         <div class="box">
            <p>Property Price <span>*</span></p>
            <input type="number" name="price" required min="0" max="9999999999" maxlength="10" placeholder="Property Price" class="input">
         </div>
         <div class="box">
            <p>Deposit Amount <span>*</span></p>
            <input type="number" name="deposite" required min="0" max="9999999999" maxlength="10" placeholder="Deposit Amount" class="input">
         </div>
         <div class="box">
            <p>Property Address <span>*</span></p>
            <input type="text" name="address" required maxlength="100" placeholder="Property Full Address" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="Square Meter" class="input">
         </div>
         <div class="box">
            <p>Property Age <span>*</span></p>
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="Age of the Property" class="input">
         </div>
         <div class="box">
            <p>Total Floors <span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="Floors Availability" class="input">
         </div>
         <div class="box">
            <p>Floor Room <span>*</span></p>
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="Floor Number" class="input">
         </div>
         <div class="box">
            <p>Loan <span>*</span></p>
      ...
      <div class="box">
         ...
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="About"></textarea>
      </div>
      <div class="checkbox">
         <div class="box">
         ...
         <div class="box">
            ...
            <p><input type="checkbox" name="market_area" value="yes" />Market</p>
         </div>
      </div>
      <div class="box">
